...
Stations attached (9 of 9 — full Pipeline Station coverage):
    ...
    S5  — ENHANCE Dispatch         (2026-06-25)
...
from engine.operator_console.stations import s5_enhance_dispatch      # noqa: F401
